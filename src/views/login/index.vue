<template>
  <div flex h-full>
    <div m-auto bg-gray-100 w-350 flex flex-col items-center border border-gray-300 p-30 rounded-10>
      ...
      <div mt-20 w-full>
        <a-checkbox v-model:checked="isRemember"  @change="onCheckAllChange">记住我</a-checkbox>
      </div>

      <div mt-20 w-full>
        <a-button w-full h-50 rounded-5 text-16 type="primary" @click="handleLogin">登录</a-button>
      </div>
    </div>
  </div>
</template>
